...
from app.libs.httprunner import exceptions, logger, utils
from app.libs.httprunner.compat import basestring, is_py2
    ...
    def _extract_field_with_delimiter(self, field):
        ...
        # elapsed
            ...
            available_attributes = (
                u"available attributes: days, seconds, microseconds, total_seconds"
            )
            if not sub_query:
        ...
        # response body
            ...
            if isinstance(body, (dict, list)):
                ...
                err_msg = (
                    u"Failed to extract attribute from response body! => {}\n".format(
                        field
                    )
                )
                err_msg += u"response body: {}\n".format(body)
        ...
        # others
            ...
            err_msg += (
                u"available response attributes: status_code, cookies, elapsed, headers, content, "
