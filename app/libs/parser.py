...
class Format(object):
    ...
    def __init__(self, body, level="test"):
        ...
        try:
            ...
            self.__json = (
                body["request"].pop("json") if "json" in body["request"] else {}
            )
            ...
            if level == "test":
                ...
                self.__skipUnless = (
                    body.pop("skipUnless") if "skipUnless" in body else True
                )
    ...
    def parse(self):
        ...
        if self.__level == "test":
            test = {
                "name": self.name,
                "times": self.__times,
                "skipUnless": self.__skipUnless,
                "request": {
                    "url": self.url,
                    "method": self.method,
                    "verify": False,
                    # 是否支持重定向，True支持，False 不支持
...
class Parse(object):
    ...
    def __init__(self, body, level="test"):
        ...
        if level == "test":
            ...
            self.__skipUnless = body.get("skipUnless", True)
    ...
    def parse_http(self):
        ...
        if self.__level == "test":
            ...
            test["skipUnless"] = self.__skipUnless
